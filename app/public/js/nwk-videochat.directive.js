    ...
    return {
        ...
        link: function(s, e, a) {
            ...
            setTimeout(function() {
                ...
                s.statusMsg = 'Etablissement de connexion en cours...';
            }, 0);
            ...
            var peer = new Peer({　
                host: 'yadenvideochat.herokuapp.com',
                secure: true,
                port: 443,
                debug: 3
            });
            ...
            peer.on('open', function(id) {
                s.id = id;
                s.statusMsg = 'Connexion au serveur...';
                s.statusMsg = 'Streaming vidéo local...';
            ...
            function initSelfVideo(cb) {
                navigator.getUserMedia({
                    ...
                    s.error = 'Impossible d\'accéder à votre caméra, veuillez réessayer !';
                });
            }
